    ...
    <div class="titlep">
        ...
        <div class="price-row">
            <div class="price-col">
                ...
                <h3>100$</h3>
                <ul>
                    <li>10kg of checked baggage</li>
                    <li>Add entertainment</li>
                    <li>Choose your seat</li>
                    <li> Date and time changes (fare difference may apply)</li>
            ...
            <div class="price-col">
                ...
                <h3>500$</h3>
                <ul>
                    <li>30kg of checked baggage</li>
                    <li>In-flight entertainment</li>
                    <li>In-Flight Meal Deals</li>
            ...
            <div class="price-col">
                ...
                <h3>850$</h3>
                <ul>
                    <li>40kg of checked baggage</li>
                    <li>In-flight entertainment</li>
                    <li>In-Flight Meal Deals</li>
                    <li>Free seat selection</li>
                    <li>Blanket, pillow, comfort pack</li>
                    <li>No change fees</li>
                    <li>Extra baggage(10kg)</li>
